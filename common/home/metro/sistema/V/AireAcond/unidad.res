!tabla que se carga cuando se pincha sobre parametros de configuracion de descongelaciono
titles: title
...
*.title.labelString: @R@CONFIGURACION UNIDAD Y CIRCUITOS@P@
...
!*.xrtTblPixelHeightSeries:     (all all 21)(1 all 14)(3 all 7)(5 all 7)(17 all 16)(18 all 30)
*.xrtTblPixelHeightSeries:     (all all 21)(1 all 14)(3 all 7)(5 all 7)(14-17 all 10)(18 all 30)
...
*.xrtTblEditableSeries:        (ALL ALL False)(2 24 True)(4 24 True)(6 24 True)
*.xrtTblTraversableSeries:     (ALL ALL False)(2 24 True)(4 24 True)(6 24 True)
*.xrtTblAllowCellResize:       RESIZE_NONE
*.xrtTblSelectionPolicy:       SELECT_NONE
!*.xrtTblBorderSidesSeries:     (ALL ALL BORDERSIDE_ALL)
*.xrtTblBorderSidesSeries:     (ALL ALL BORDERSIDE_NONE)(0 11 BORDERSIDE_ALL)(0 28 BORDERSIDE_ALL) \
                               (0 52 BORDERSIDE_ALL)(2 24 BORDERSIDE_ALL) \
                               (4 24 BORDERSIDE_ALL)(6 24 BORDERSIDE_ALL)
