!tabla que se carga cuando se pincha sobre parametros de sondas de temperatura

titles: title
*.title.fontList: \
	          -b&h-lucida-bold-r-normal-sans-18-180-75-75-p-120-iso8859-1
*.title.labelString: @R@CONFIGURACION SONDAS DE TEMPERATURA@P@
...
! Carga el mismo ascii que estados xq solo cambian los botones
*.xrtTblCellValues:            sondas.ascii

*.xrtTblFontListSeries: (all all -b&h-lucida-bold-r-normal-sans-12-120-75-75-p-79-iso8859-1)
*.xrtTblBackgroundSeries:      (all all gray80)(0 11 gray90)(0 28 gray90)(0 52 gray90)(2 24 gray90)(2 55 gray90) \
                               (4 24 gray90)(4 55 gray90)(6 24 gray90)(6 55 gray90)(8 24 gray90)(8 55 gray90) \
                               (10 24 gray90)(10 55 gray90)
*.xrtTblForegroundSeries:      (all all black)(15 all white)
*.xrtTblPixelWidthSeries:      (all all 14)
*.xrtTblPixelHeightSeries:     (all all 21)(1 all 14)(3 all 7)(5 all 7)(7 all 7)(9 all 7)(14 all 68)(15 all 30)
...
*.xrtTblAlignmentSeries:       (ALL ALL ALIGNMENT_MIDDLECENTER) \
                               (0 44 ALIGNMENT_MIDDLEBEGIN)(ALL 34 ALIGNMENT_MIDDLEBEGIN) \
                               (ALL 3 ALIGNMENT_MIDDLEBEGIN)(ALL 59 ALIGNMENT_MIDDLEBEGIN)
*.xrtTblEditableSeries:        (ALL ALL False)(2 24 True)(2 55 True)(4 24 True)(4 55 True)
                               (6 24 True)(6 55 True)(8 24 True)(8 55 True)(10 24 True)(10 55 True) 
...
*.xrtTblBorderSidesSeries:     (ALL ALL BORDERSIDE_NONE) \
                               (0 11 BORDERSIDE_ALL)(0 28 BORDERSIDE_ALL)(0 52 BORDERSIDE_ALL) \
                               ...
                               (10 24 BORDERSIDE_ALL)(10 55 BORDERSIDE_ALL)
...
*.xrtTblSpanList:     (0,3 0,10)(0,11 0,18)(0,23 0,27)(0,28 0,39)(0,44 0,51)(0,52 0,60) \
                      ...
                      (4,3 4,23)(4,24 4,26)(4,34 4,54)(4,55 4,57)(4,59 4,60) \
                      (6,3 6,23)(6,24 6,26)(6,34 6,54)(6,55 6,57)(6,59 6,60) \
                      (8,3 8,23)(8,24 8,26)(8,34 8,54)(8,55 8,57)(8,59 8,60) \
                      (10,3 10,23)(10,24 10,26)(10,34 10,54)(10,55 10,57)(10,59 10,60) \
