!tabla que se carga cuando se pincha sobre parametros de configuracion de antihielo
titles: title
*.title.fontList: \
	          -b&h-lucida-bold-r-normal-sans-18-180-75-75-p-120-iso8859-1
*.title.labelString: @R@CONFIGURACION ANTIHIELO@P@
...
*.xrtTblCellValues:            antihielo.ascii
...
*.xrtTblBackgroundSeries:      (all all gray80)(0 11 gray90)(0 28 gray90)(0 52 gray90) \
                               ...
                               (4 24 gray90)(4 55 gray90)(6 24 gray90)(6 55 gray90)(8 24 gray90) \
                               (8 55 gray90)(10 24 gray90)(10 55 gray90)
*.xrtTblForegroundSeries:      (all all black)(15 all white)
*.xrtTblPixelWidthSeries:      (all all 14)
*.xrtTblPixelHeightSeries:     (all all 21)(0 all 21)(1 all 14)(3 all 7)(5 all 7)(7 all 7)(9 all 7)(14 all 68)(15 all 30)
...
*.xrtTblSpanList:     (0,3 0,10)(0,11 0,18)(0,23 0,27)(0,28 0,39)(0,44 0,51)(0,52 0,60) \
                      (1,0 1,30)(1,33 1,63) \
                      (2,3 2,23)(2,24 2,26)(2,28 2,29)(2,34 2,54)(2,55 2,57) \
