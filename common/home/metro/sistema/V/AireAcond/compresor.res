!tabla que se carga cuando se pincha sobre parametros de configuracion de compresores
titles: title
...
*.title.labelString: @R@CONFIGURACION SEGURIDAD COMPRESORES@P@
...
*.xrtTblCellValues:            compresor.ascii
...
*.xrtTblBackgroundSeries:      (all all gray80)(0 11 gray90)(0 28 gray90)(0 52 gray90) \
                               (2 24 gray90)(4 24 gray90)(6 24 gray90)(8 24 gray90)
*.xrtTblForegroundSeries:      (all all black)(18 all white)
*.xrtTblPixelWidthSeries:      (all all 14)
*.xrtTblPixelHeightSeries:     (all all 21)(1 all 14)(3 all 7)(5 all 7)(7 all 7)(9 all 7)(11 all 7)(13 all 7)(15 all 7)(17 all 47)(18 all 30)
...
*.xrtTblEditableSeries:        (ALL ALL False)(2 24 True)(4 24 True)(6 24 True)(8 24 True)
*.xrtTblTraversableSeries:     (ALL ALL False)(2 24 True)(4 24 True)(6 24 True)(8 24 True)
...
*.xrtTblBorderSidesSeries:     (ALL ALL BORDERSIDE_NONE)(0 11 BORDERSIDE_ALL)(0 28 BORDERSIDE_ALL)(0 52 BORDERSIDE_ALL) \
                               (2 24 BORDERSIDE_ALL)(4 24 BORDERSIDE_ALL)(6 24 BORDERSIDE_ALL)(8 24 BORDERSIDE_ALL)
