...
*.xrtTblFontListSeries: \
	(all all -b&h-lucida-bold-r-normal-sans-24-240-75-75-p-152-iso8859-1)
!*.xrtTblCellValues:            volcado.ascii
*.xrtTblBackgroundSeries:      (all all gray80)
*.xrtTblForegroundSeries:      (all all black)
*.xrtTblPixelWidthSeries:      (all all 800)
*.xrtTblPixelHeightSeries:     (all all 100)
*.xrtTblBorderTypeSeries:      (all all border_in) 
*.xrtTblShadowThickness:       0
*.xrtTblMarginWidth:           0
