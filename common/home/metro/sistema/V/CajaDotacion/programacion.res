! tabla de salida cuando se pincha en PROGRAMACION
...
!*.xrtTblCellValues:            ./programacion.ascii
...
*.xrtTblBackgroundSeries:      (all all gray80)(label all #677a8d)(label 0-5 gray80) \
                               (3-38 6-42 gray90)(3 15-19 #777a8d)

!*.xrtTblBackgroundSeries:      (all all gray73) \
!                               (label all lightblue) \
!                               (label 0-5 #AEB2C3) \
!                               (0 all gray73) \
!                               (1 all gray73) \
!                               (2 all gray73)
*.xrtTblForegroundSeries:      (all all black) \
                               (label all white)
*.xrtTblPixelWidthSeries:      (all all 18) 
*.xrtTblPixelHeightSeries:     (all all 19)(0 all 25)(1 all 29)(2 all 25)
...
*.xrtTblBorderSidesSeries:     (ALL ALL BORDERSIDE_ALL)(0 ALL BORDERSIDE_NONE) \
                               (0-39 0-5 BORDERSIDE_NONE)(label 0-5 BORDERSIDE_NONE) \
                               (1 ALL BORDERSIDE_NONE)(2 ALL BORDERSIDE_NONE)
...
*.xrtTblSpanList:              (label,6 label,9)(label,10 label,19)(label,20 label,28)(label,29 label,35)(label,36 label,43) \
                               (3,6 3,9)(3,10 3,19)(3,20 3,28)(3,29 3,35)(3,36 3,43) \
