! tabla de salida cuando se pincha en ACTIVAR PERIODO
...
!*.xrtTblCellValues:            ./programacion.0.ascii
...
*.xrtTblBackgroundSeries:      (all all gray80)(label all #677a8d)(label 0-5 gray80) \
                               (4-39 6-42 gray90)(3 15 #768ca1)(3 29 #768ca1) \
                               (1 25 gray90)(1 33 gray90)(1 40 gray90)
*.xrtTblForegroundSeries:      (all all black)(label all white)(1 all brown) \
                               (3 15 white)(3 29 white)
*.xrtTblPixelWidthSeries:      (all all 18) 
*.xrtTblPixelHeightSeries:     (all all 19)(0 all 28)(1 all 25)(2 all 15)(3 all 25)
...
*.xrtTblNumRows:               40
*.xrtTblNumColumns:            43
*.xrtTblAlignmentSeries:       (all all ALIGNMENT_MIDDLECENTER)(1 all ALIGNMENT_BOTTOMCENTER)(1 25 ALIGNMENT_MIDDLECENTER) \
                               (1 33 ALIGNMENT_MIDDLECENTER)(1 40 ALIGNMENT_MIDDLECENTER)
*.xrtTblEditableSeries:        (ALL ALL False)(1 25 True)(1 33 True)(1 40 True) 
*.xrtTblTraversableSeries:     (ALL ALL False)(1 25 True)(1 33 True)(1 40 True) 
*.xrtTblAllowCellResize:       RESIZE_NONE
*.xrtTblSelectionPolicy:       SELECT_NONE
*.xrtTblBorderSidesSeries:     (ALL ALL BORDERSIDE_ALL)(1 ALL BORDERSIDE_NONE) \
                               (1-43 0-5 BORDERSIDE_NONE)(1 0-18 BORDERSIDE_NONE) \
                               (1 25 BORDERSIDE_ALL)(1 33 BORDERSIDE_ALL) \
                               (1 40 BORDERSIDE_ALL)(label 0-5 BORDERSIDE_NONE) \
                               (0 ALL BORDERSIDE_NONE)(2 ALL BORDERSIDE_NONE) \
                               (3 ALL BORDERSIDE_NONE)(3 15-19 BORDERSIDE_ALL) \
                               (3 29-33 BORDERSIDE_ALL)
...
*.xrtTblSpanList:              (label,6 label,9)(label,10 label,19)(label,20 label,28)(label,29 label,35)(label,36 label,43) \
                               ...
                               (1,6 1,20) \ (1,22 1,24)(1,25 1,27)(1,28 1,32)(1,33 1,35)(1,36 1,39)(1,40 1,42) \
                               (3,15 3,19)(3,29 3,33)
